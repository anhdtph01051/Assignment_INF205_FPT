<%@ Page Title="" Language="C#" MasterPageFile="~/Theme.master" AutoEventWireup="true" CodeFile="sanpham.aspx.cs" Inherits="sanpham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table border="0" style="text-align:center;">
        ...
        <tr>
            ...
            <td width="52px"></td>
            <td class="namequanao" width="210px" height="70px" style="color: #993399; background-color: #CC0000">Áo khoác lông vũ Diesel hàng hiệu xuất khẩu màu nâu</td>
            <td width="52px"></td>
            <td class="namequanao" width="210px" height="70px">Áo khoác lông vũ Diesel hàng hiệu xuất khẩu màu nâu</td>
            <td width="52px"></td>
            <td class="namequanao" width="210px" height="70px">Áo khoác lông vũ Diesel hàng hiệu xuất khẩu màu nâu</td>
